...
As has already been explained, the act of authentication alone does not approve or deny the request--that requires the act of _authorization_ which is covered in <<authorization, the next section>>.
