...
Most web libraries to the same thing: call your code with some request data and ask you to return a response. This leaves the responsibililty for setting the correct status code and response headers with you, the developer.

[yada]#yada# is _different_ - rather than leaving all the implementation details to you, it helps you out in _doing the right thing_, setting the correct statuses and headers, and creating services that align better with the HTTP specifications, thereby creating a link:https://www.pandastrike.com/posts/20151019-create-more-web[_better web_].

Using [yada]#yada# for your web project will allow you to finally exploit and benefit from the many outstanding features contained in the design of HTTP, for scale, flexibility, longevity and interoperability.

=== [yada]#yada#'s design goals:
...
Some familiarity with HTTP will help, but as you learn how to wield [yada]#yada# you will also discover and learn more about the HTTP standards as you go.
